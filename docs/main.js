...
var $author$project$Styles$Dark = {$: 'Dark'};
...
var $author$project$Main$Model = F6(
	function (key, dimensions, url, style, page, styleAnimations) {
		return {dimensions: dimensions, key: key, page: page, style: style, styleAnimations: styleAnimations, url: url};
	});
var $author$project$Main$NotFound = {$: 'NotFound'};
var $author$project$Main$Projects = {$: 'Projects'};
var $author$project$Main$Resume = {$: 'Resume'};
var $author$project$Main$ResumeExport = {$: 'ResumeExport'};
...
var $author$project$Main$IndexRoute = {$: 'IndexRoute'};
var $author$project$Main$ProjectsRoute = {$: 'ProjectsRoute'};
var $author$project$Main$ProjectsViewRoute = function (a) {
	return {$: 'ProjectsViewRoute', a: a};
};
var $author$project$Main$ResumeExportRoute = {$: 'ResumeExportRoute'};
var $author$project$Main$ResumeRoute = {$: 'ResumeRoute'};
			...
			switch (_v0.a.$) {
				...
				case 'ResumeRoute':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{page: $author$project$Main$Resume}),
						$elm$core$Platform$Cmd$none);
				case 'ResumeExportRoute':
					var _v3 = _v0.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{page: $author$project$Main$ResumeExport}),
						$elm$core$Platform$Cmd$none);
				case 'ProjectsRoute':
					var _v4 = _v0.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{page: $author$project$Main$Projects}),
						$elm$core$Platform$Cmd$none);
				default:
					var project = _v0.a.a;
					return _Utils_Tuple2(
...
var $author$project$Main$init = F3(
	function (keys, url, key) {
		return A2(
			...
			url,
			A6($author$project$Main$Model, key, keys, url, $author$project$Styles$Dark, $author$project$Main$Index, 0));
	});
...
var $author$project$Main$SwitchThemeDone = function (a) {
	return {$: 'SwitchThemeDone', a: a};
};
var $author$project$Styles$Light = {$: 'Light'};
var $author$project$Styles$flip = function (style) {
	if (style.$ === 'Dark') {
		return $author$project$Styles$Light;
	} else {
		return $author$project$Styles$Dark;
	}
};
...
var $author$project$Main$openInternalUrl = F2(
	function (key, url) {
		var _v0 = A2($elm$url$Url$Parser$parse, $author$project$Main$parser, url);
		if ((_v0.$ === 'Just') && (_v0.a.$ === 'ProjectsViewRoute')) {
			var project = _v0.a.a;
		...
		switch (msg.$) {
			case 'LinkClicked':
				...
				if (urlRequest.$ === 'Internal') {
					...
					return _Utils_Tuple2(
						model,
						A2($author$project$Main$openInternalUrl, model.key, url));
				} else {
			...
			case 'SwitchTheme':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{styleAnimations: model.styleAnimations + 1}),
					A2(
						$elm$core$Task$perform,
						...
						A2(
							$elm$core$Task$andThen,
							function (_v2) {
								return $elm$core$Task$succeed(model.styleAnimations + 1);
							},
							$elm$core$Process$sleep($author$project$Main$styleSwitchDuration))));
			default:
				var count = msg.a;
				if (_Utils_eq(count, model.styleAnimations)) {
					var style = (!(count % 2)) ? model.style : $author$project$Styles$flip(model.style);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{style: style, styleAnimations: 0}),
						$elm$core$Platform$Cmd$none);
				} else {
...
var $author$project$Main$bar = F2(
	function (model, contextActions) {
		...
		return A2(
			...
			A2($author$project$Styles$bar, model.style, _List_Nil),
			_List_fromArray(
				[
					A2(
					$mdgriffith$elm_ui$Element$link,
					A2($author$project$Styles$button, model.style, _List_Nil),
					{
						label: $author$project$ElementFix$text('Home'),
						url: '/'
					}),
					A2(
					$mdgriffith$elm_ui$Element$link,
					A2($author$project$Styles$button, model.style, _List_Nil),
					{
						label: $author$project$ElementFix$text('Projects'),
						url: '/projects'
					}),
					A2(
					$mdgriffith$elm_ui$Element$link,
					A2($author$project$Styles$button, model.style, _List_Nil),
					{
						label: $author$project$ElementFix$text('Resume'),
						url: '/resume'
					}),
					A2(
					$mdgriffith$elm_ui$Element$row,
					...
					A2($author$project$Styles$button, model.style, _List_Nil),
					{
						label: A2(
							...
							_Utils_ap(
								...
								styleAttributes),
							{description: 'Dark/Light mode switch', src: styleIcon}),
...
var $author$project$Resume$paddingLeft = function (pad) {
	return $mdgriffith$elm_ui$Element$paddingEach(
		{bottom: 0, left: pad, right: 0, top: 0});
};
							...
							label: A2(
								...
								_List_fromArray(
									[
										...
										{description: 'GitHub logo', src: '/assets/GitHub-Mark-32px.png'}),
										A2(
										$mdgriffith$elm_ui$Element$el,
										$author$project$Resume$extrasTextStyle(_List_Nil),
										$author$project$ElementFix$text('Anfid'))
...
var $author$project$Resume$heading = A2(
	...
	_List_fromArray(
		[
			...
			{description: '', src: '/assets/resume_photo.png'}),
			A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
		...
		return _Utils_ap(
			_List_fromArray(
				[
					...
					{bottom: 0, left: padding, right: 0, top: 0}),
	...
	return A2(
		...
		_List_fromArray(
			[
				A2(
				$mdgriffith$elm_ui$Element$paragraph,
				A2($author$project$Styles$paragraph, model.style, _List_Nil),
				_List_fromArray(
					[
					...
					[
						...
						_List_fromArray(
							[
								...
								A3($author$project$Main$link, model.style, 'my resume here', '/resume'),
								$author$project$ElementFix$text('. If you need to download it, '),
								A2(
								$mdgriffith$elm_ui$Element$downloadAs,
								A2($author$project$Styles$link, model.style, _List_Nil),
								{
									filename: 'Mikhail-Pogretskiy.pdf',
									label: $author$project$ElementFix$text('click here'),
						...
						_List_fromArray(
							[
								...
								A3($author$project$Main$link, model.style, 'personal projects', '/projects'),
								$author$project$ElementFix$text('.')
							]))
					]))
			]));
							...
							[
								...
								_List_fromArray(
									[
										...
										{description: 'Mandelbrot zoom-in screenshot', src: 'https://raw.githubusercontent.com/Anfid/media/master/Minibrot.png'}),
										A2(
										$mdgriffith$elm_ui$Element$row,
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												A2($author$project$Main$liveDemoButton, model.style, '/projects/mandelbrot/index.html'),
												A2($author$project$Main$sourceButton, model.style, 'https://github.com/Anfid/mandelbrot')
											])),
										A2(
										...
										_List_fromArray(
											[
												$author$project$ElementFix$text('Mandelbrot set visualization powered by WebGPU. Since technology is very young, browser ' + ('and driver support may be limited. For an up-to-date list of browsers that support ' + 'WebGPU, see ')),
												A3($author$project$Main$link, model.style, 'this MDN doc', 'https://developer.mozilla.org/en-US/docs/Web/API/WebGPU_API#browser_compatibility'),
												$author$project$ElementFix$text('.')
											]))
									]))
							])),
							...
							[
								...
								_List_fromArray(
									[
										...
										{description: 'dnd-stuff screenshot', src: '/assets/projects/dnd-stuff_demo.jpg'}),
										A2(
										$mdgriffith$elm_ui$Element$row,
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												A2($author$project$Main$liveDemoButton, model.style, '/projects/dnd-stuff/index.html'),
												A2($author$project$Main$sourceButton, model.style, 'https://github.com/Anfid/dnd-stuff')
											])),
										A2(
										$author$project$Main$techStack,
										model.style,
										...
										_List_fromArray(
											[
												...
												A3($author$project$Main$link, model.style, 'rumkin.com/reference/dnd/diestats.php', 'http://rumkin.com/reference/dnd/diestats.php'),
							...
							[
								...
								_List_fromArray(
									[
										...
										{description: 'coppe-wm screenshot', src: '/assets/projects/coppe_demo.jpg'}),
										A2(
										$mdgriffith$elm_ui$Element$row,
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												A2($author$project$Main$sourceButton, model.style, 'https://github.com/Anfid/coppe-wm')
											])),
										A2(
										$author$project$Main$techStack,
										model.style,
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												A2($author$project$Main$sourceButton, model.style, 'https://github.com/Anfid/water')
											])),
										A2(
										$author$project$Main$techStack,
										model.style,
							...
							[
								...
								_List_fromArray(
									[
										...
										{description: 'GItask screenshot', src: '/assets/projects/GItask_demo.jpg'}),
										A2(
										$mdgriffith$elm_ui$Element$row,
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												A2($author$project$Main$sourceButton, model.style, 'https://github.com/Anfid/GItask')
											])),
										A2(
										$author$project$Main$techStack,
										model.style,
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												A2($author$project$Main$sourceButton, model.style, 'https://github.com/Anfid/Anfid.github.io')
											])),
										A2(
										$author$project$Main$techStack,
										model.style,
		...
		case 'Index':
			return A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Background$color(
						$author$project$Styles$bgColor(model.style)),
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
						$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
						$mdgriffith$elm_ui$Element$spacing(30)
					]),
							...
							[
								...
								A2($author$project$Styles$button, model.style, _List_Nil),
								{
									...
									label: A2(
										...
										{description: 'Download', src: '/assets/download.png'}),
									url: '/assets/resume.pdf'
								}),
								A2(
								$mdgriffith$elm_ui$Element$link,
								A2($author$project$Styles$button, model.style, _List_Nil),
								{
									label: A2(
										...
										{description: 'Print', src: '/assets/print.png'}),
									url: '/resume/export'
								})
							])),
						A2(
							...
							A2(
								...
								_List_fromArray(
									[
										...
										{bottomLeft: 50, bottomRight: 0, topLeft: 0, topRight: 0})
									])),
							{
								label: A2(
									$mdgriffith$elm_ui$Element$el,
									_List_fromArray(
										[
											$mdgriffith$elm_ui$Element$paddingEach(
											{bottom: 15, left: 25, right: 10, top: 5}),
									...
									A2(
										...
										{description: 'Print', src: '/assets/print.png'})),
								onPress: $elm$core$Maybe$Just($author$project$Main$Print)
							}))
					]),
				A2(
					$mdgriffith$elm_ui$Element$el,
		...
		return (count > 0) ? A2(
			...
			$mdgriffith$elm_ui$Element$inFront(
				A5(
					...
					A3(
						...
						{
							duration: $author$project$Main$styleSwitchDuration,
						...
						_List_fromArray(
							[
								...
								'circle(' + ($elm$core$String$fromInt(
									2 * A2($elm$core$Basics$max, model.dimensions.height, model.dimensions.width)) + ('px at ' + ($elm$core$String$fromInt(x) + ('px ' + ($elm$core$String$fromInt(y) + 'px)'))))))
							])),
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
			...
			A5(
				...
				_Utils_update(
					model,
					{
						style: $author$project$Styles$flip(model.style)
					}))) : _List_Nil;
	});
		...
		return A2(
			...
			_Utils_ap(
				...
				A5(
					$author$project$Main$styleStack,
					fView,
					model.dimensions.width - 20,
					20,
					model.styleAnimations,
					_Utils_update(
						model,
						{
							style: $author$project$Styles$flip(model.style)
